const dicas = {
    ...
    "Agripa-1": [
        ...
        "Dica 2: É conhecido por ter perseguido a igreja e mandado prender Pedro",
        "Dica 3: Também mandou matar Tiago, irmão de João, filhos de Zebedeu",
        "Dica 4: Durante um discurso, foi atingido por uma praga e morreu (Atos 12:20-23)",
        "Não há mais dicas disponíveis"
    ],
    "Agripa-2": [
        "Dica 1: Era membro da dinastia herodiana e portanto, rei da Judeia",
        "Dica 2: Seu pai tinha um nome igual ao dele",
        "Dica 3: Ele presidiu o julgamento do apóstolo Paulo em Cesareia",
        "Dica 4: Ao ouvir Paulo, disse: 'Falta pouco para você convencer-me a tornar-me cristão'",
        "Não há mais dicas disponíveis"
    ],
    "Aias": [
    ...
    "Atalia": [
        "Dica 1: Filha de Acabe e Jezabel, da descendência de Onri",
        "Dica 2: Foi dada em casamento a Jorão, mediante aliança feita entre o reino do norte (Israel) e o do sul (Judá)",
        "Dica 3: Após a morte de seu marido e filho, mandou matar todos os descendentes reais de Judá",
        "Dica 4: Foi rainha de Judá por seis anos.",
